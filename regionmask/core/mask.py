...
def _mask(
    ...
    if method == "rasterize":
        mask = _mask_rasterize(lon, lat, outlines, numbers=numbers,all_touched=all_touched)
    elif method == "rasterize_flip":
        mask = _mask_rasterize_flip(lon, lat, outlines, numbers=numbers,all_touched=all_touched)
    elif method == "rasterize_split":
        mask = _mask_rasterize_split(lon, lat, outlines, numbers=numbers,all_touched=all_touched)
    elif method == "shapely":
